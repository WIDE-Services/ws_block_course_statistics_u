 ...
 * Class main
 */
class generalmeasures implements renderable, templatable {
     ...
     * @param bool $access
     */
    public function __construct($params = null, $form = null, $coursedata = null ,
    ...
    public function export_for_template(renderer_base $output) {
            ...
            return $data = [
                    ...
                    'urlcourse' => new moodle_url('/blocks/course_statistics/pages/admin/generalmeasures/index.php?courseid='.
                            $this->courseid),
                    ...
                    'viewusers' => new moodle_url('/blocks/course_statistics/pages/admin/generalmeasures/index.php?viewusers=1'
                    ),
